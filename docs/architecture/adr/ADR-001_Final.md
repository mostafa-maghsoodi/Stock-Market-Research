# ADR-001 — Post-Run-2 successor architecture
...
Post-Run-2 successor architecture
...
Architecture v3.2 is the governing post-Run-2 successor direction.
Architecture v3.1 remains immutable historical evidence.

## Scope

This decision governs the successor direction while preserving Architecture
v3.1 unchanged as historical evidence.

## What this decision does NOT authorize

It does not rewrite Architecture v3.1, approve exact Architecture v3.2 bytes,
select implementation values, authorize outcomes, or freeze any artifact.

## Relationship to Architecture v3.2

Architecture v3.2 implements this successor direction but becomes governing
as an exact document only through its separate approval process.
